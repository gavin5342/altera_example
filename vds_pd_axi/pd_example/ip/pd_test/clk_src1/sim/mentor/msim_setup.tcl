...
# ----------------------------------------
# If clk_src1 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk_src1.clk_src1"
}
...
append ELAB_OPTIONS [subst [clk_src1::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [clk_src1::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [clk_src1::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [clk_src1::normalize_path "$file"]
  set normalized_dest [clk_src1::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [clk_src1::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [clk_src1::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [clk_src1::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [clk_src1::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
