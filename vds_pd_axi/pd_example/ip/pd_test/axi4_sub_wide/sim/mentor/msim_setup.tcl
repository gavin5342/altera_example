...
# ----------------------------------------
# If axi4_sub_wide is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "axi4_sub_wide.axi4_sub_wide"
}
...
append ELAB_OPTIONS [subst [axi4_sub_wide::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [axi4_sub_wide::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [axi4_sub_wide::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [axi4_sub_wide::normalize_path "$file"]
  set normalized_dest [axi4_sub_wide::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [axi4_sub_wide::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [axi4_sub_wide::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [axi4_sub_wide::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [axi4_sub_wide::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
