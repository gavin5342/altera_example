	component axi4_mgr_narrow is
		...
		port (
			...
			awaddr   : out std_logic_vector(22 downto 0);                    -- awaddr
			awid     : out std_logic_vector(3 downto 0);                     -- awid
			awuser   : out std_logic_vector(31 downto 0);                    -- awuser
			araddr   : out std_logic_vector(22 downto 0);                    -- araddr
	...
	end component axi4_mgr_narrow;

	u0 : component axi4_mgr_narrow
		generic map (
