...
# ----------------------------------------
# If rst_src is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "rst_src.rst_src"
}
...
append ELAB_OPTIONS [subst [rst_src::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [rst_src::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [rst_src::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [rst_src::normalize_path "$file"]
  set normalized_dest [rst_src::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [rst_src::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [rst_src::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [rst_src::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [rst_src::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
