// pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_fxvjijy.v

// Generated using ACDS version 26.1 110

`timescale 1 ps / 1 ps
module pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_fxvjijy #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 481,
		...
		input  wire [480:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [480:0] out_data           //          .data,          Output Data port of Avalon Streaming Source Interface
	);
	...
	pd_test_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 481,          .data
		...
		.out_data          (out_data),          //  output,  width = 481,          .data
