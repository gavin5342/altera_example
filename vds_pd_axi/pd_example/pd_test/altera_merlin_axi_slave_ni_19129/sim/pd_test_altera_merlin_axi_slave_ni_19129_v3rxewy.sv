...
module pd_test_altera_merlin_axi_slave_ni_19129_v3rxewy
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    pd_test_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19129_3jmi5ry #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_qot3jfy #(
      .SYMBOLS_PER_BEAT (1),
    ...
    pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_pyxt2rq #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_fxvjijy #(
             .SYMBOLS_PER_BEAT (1),
