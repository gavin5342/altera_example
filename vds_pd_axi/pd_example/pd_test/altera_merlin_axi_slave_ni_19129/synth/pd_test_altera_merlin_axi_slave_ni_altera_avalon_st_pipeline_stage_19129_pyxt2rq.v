// pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_pyxt2rq.v

// Generated using ACDS version 26.1 110

`timescale 1 ps / 1 ps
module pd_test_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_pyxt2rq #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 39,
		...
		input  wire [38:0] in_data,   //          .data,  Input Data port of Avalon Streaming Sink Interface
		...
		output wire [38:0] out_data   //          .data,  Output Data port of Avalon Streaming Source Interface
	);
	...
	pd_test_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),   //   input,  width = 39,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 39,          .data
